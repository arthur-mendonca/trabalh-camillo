...
type Role = "ADMIN" | "BIBLIOTECARIO" | "ALUNO";

type NavItem = {
  name: string;
  href: string;
  icon: React.ComponentType<React.SVGProps<SVGSVGElement>>;
  roles: Role[]; // quem pode ver esse item
};
...
const navItems: NavItem[] = [
  {
    ...
    href: "/dashboard",
    icon: ChartPieIcon,
    roles: ["ADMIN", "BIBLIOTECARIO"], // aluno NÃO vê
  },
  {
    name: "Livros",
    href: "/books",
  ...
  },
  {
    ...
    href: "/profile",
    icon: UserIcon,
    roles: ["ADMIN", "BIBLIOTECARIO", "ALUNO"], // todos veem
  },
...
export function Sidebar() {
  ...
  // Se não tiver usuário logado, não mostra sidebar
  if (!user) return null;

  // filtra os itens de acordo com o tipo de usuário
